<template>
  <div>
    <b-input v-model="subject" placeholder="방명록을 남겨주세요."></b-input>
    <b-form-textarea
        v-model="context"
...
export default {
  ...
  methods: {
       ...
       uploadContent() { // 저장
        ...
        const content_id = items[0].content_id + 1;  // 마지막 데이터의 id + 1
        ...
        localStorage.setItem('items', JSON.stringify(data.Content)); //로컬에 JSON 
